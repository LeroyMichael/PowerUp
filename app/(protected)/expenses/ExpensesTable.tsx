                                ...
                                <TableRow key={idx}>
                                    <TableCell>
                                        <DropdownMenu>
                                            ...
                                            className="w-[160px] "
                                            >
                                            <DropdownMenuItem className="cursor-pointer" onClick={() => router.push(`/expenses/${expense.expense_id}`)}>
                                                Make a copy
                                            </DropdownMenuItem>
                                            <DropdownMenuItem
                                            ...
                                            <DropdownMenuItem
                                                onClick={() => callMarkAsPaidExpense(expense.expense_id, expense.status === "ACTIVE")}
                                    ...
                                    <TableCell>
                                        <Badge
                                            variant={expense.payment_status === "PAID" ? "paid" : "draft"}
                                        >
