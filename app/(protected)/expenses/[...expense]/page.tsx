...
import convertExpenseFormToMutation, {
  createExpense,
  getExpensesById,
  updateExpenses,
...
const ExpenseDetailPage = ({ params }: { params: { expense: string } }) => {
  ...
  const onSubmit: SubmitHandler<ExpensesFormDataType> = (
    data: ExpensesFormDataType
  ) => {
    const expenseBody = {
  ...
  const onSubmitWithPay: SubmitHandler<ExpensesFormDataType> = (
    data: ExpensesFormDataType
  ) => {
    const expenseBody = {
      ...convertExpenseFormToMutation(data),
  ...
  const onSubmitMakeACopy: SubmitHandler<ExpensesFormDataType> = async (
    data: ExpensesFormDataType
  ) => {
