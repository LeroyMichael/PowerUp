  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Add Customer Details</CardDescription>
      </CardHeader>
      <Separator />
      <CardContent>
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    watchForm.contact_id === customer.contact_id && "bg-muted"
                  )}
        ...
        {errors.contact_id?.message && (
          <p className="text-red-500">Please select Customer</p>
        )}
