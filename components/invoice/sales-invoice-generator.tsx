...
//   const withDelivery = Number(
//     (props.data.subtotal ?? 0) + (props.data.delivery ?? 0)
//   );
//   const totalAfterDiscount = withDelivery - (props.data.discount_value ?? 0);
//   const totalTax = (totalAfterDiscount * (props.data.tax ?? 0)) / 100;
//   const total = totalAfterDiscount + totalTax;
//   const totalDP = (total * (props.data.down_payment_amount ?? 0)) / 100;
...
//                 {props.data.transaction_type == "Penawaran"
//                   ? "Surat Penawaran"
//                   : props.data.transaction_type == "Pro Invoice"
//                   ? "Proforma Invoice"
...
//               {props.data.transaction_type == "Invoice" ||
//               props.data.transaction_type == "Penawaran" ? (
